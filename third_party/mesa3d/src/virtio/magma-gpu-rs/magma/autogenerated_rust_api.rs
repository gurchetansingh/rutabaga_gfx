...
impl MagmaSubmitInfo {
    ...
    pub fn buffer_info(&self) -> Option<&MagmaSubmitBufferInfo> {
        self.get_extension::<MagmaSubmitBufferInfo>()
    }

    pub fn buffer_info_mut(&mut self) -> Option<&mut MagmaSubmitBufferInfo> {
        unsafe { self.get_extension_mut::<MagmaSubmitBufferInfo>() }
    }
}
